 ...
 const navigate = useNavigate();
  ...
  return (
      ...
      <img src={logoMobile} className="signup-mobile" alt="logo" />
        ...
        <p><img src={icon} className="list-icon" alt="list-icon"/>Product discovery and building what matters</p>
        <p><img src={icon} className="list-icon" alt="list-icon"/>Measuring to ensure updates are a success</p>
        <p><img src={icon} className="list-icon" alt="list-icon"/>And much more!</p>
